...
function openMenu() {
  ...
  navmenu.style.marginRight = "0px";
    navmenu.style.paddingRight = "40px";
  navbar.style.background="#fff";
  navlink.style.background="#fff";
  navlink2.style.background="#fff";
  navlink3.style.background="#fff";
  navlink4.style.background="#fff";
  navlink5.style.background="#fff";
  ...
  navlink5.style.display = "flex";
  navlink.style.alignItems = "center";
  navlink2.style.alignItems = "center";
  navlink3.style.alignItems = "center";
  navlink4.style.alignItems = "center";
  navlink5.style.alignItems = "center";
  navlink.style.justifyContent = "right";
  navlink2.style.justifyContent = "right";
  navlink3.style.justifyContent = "right";
  navlink4.style.justifyContent = "right";
  navlink5.style.justifyContent = "right";
...
function closeMenu() {
  ...
  setTimeout(() => {
      ...
      navlink2.style.justifyContent = "center";
      navlink3.style.justifyContent = "center";
      navlink4.style.justifyContent = "center";
      navlink5.style.justifyContent = "center";
