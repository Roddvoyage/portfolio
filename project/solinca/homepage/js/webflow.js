...
function scrolltextoverpersonaltrainer(){
    servicos.style.marginTop="0px";
    servicos.style.transition="margin-top 0.2s ease-in";
    servicos.innerHTML="personal trainer";
};

function scrolltextovernutricao(){
    servicos.style.marginTop="0px";
    servicos.style.transition="margin-top 0.2s ease-in";
    servicos.innerHTML="nutrição";
};

function scrolltextoverswimming(){
    servicos.style.marginTop="0px";
    servicos.style.transition="margin-top 0.2s ease-in";
    servicos.innerHTML="natação";
};

function scrolltextoverkids(){
    servicos.style.marginTop="0px";
    servicos.style.transition="margin-top 0.2s ease-in";
    servicos.innerHTML="kids";
};

function scrolltextoverevaluation(){
    servicos.style.marginTop="0px";
    servicos.style.transition="margin-top 0.2s ease-in";
    servicos.innerHTML="avaliação";
};


function scrolltextleave(){
    servicos.style.marginTop="30px";
    servicos.style.transition="margin-top 0.2s ease-out";
};
...
let navmenu2=document.querySelector(".w-nav-menu-2");
let iconnavmenu=document.querySelector(".w-icon-nav-menu");
let navmenubutton=document.querySelector(".w-nav-button");
let navlinka = document.querySelector(".navlink.w-nav-link.a");
let navlinkb = document.querySelector(".navlink.w-nav-link.b");
let navlinkc = document.querySelector(".navlink.w-nav-link.c");
let navlinkd = document.querySelector(".navlink.w-nav-link.d");
let navlinke = document.querySelector(".navlink.w-nav-link.e");
...
let originalStyles = {
  ...
  containerstylejustifyContent:container.style.justifyContent,
  navmenustylebackgroundColor : navmenu.style.backgroundColor,
  navmenustyleborderRadius: navmenu.style.borderRadius,
  iconnavmenustylebackgroundColor: iconnavmenu.style.backgroundColor,
  navmenubuttonstylebackgroundColor: navmenubutton.style.backgroundColor,
  navmenubuttonstylemarginRight: navmenubutton.style.marginRight,
  navmenustylejustifyContent : navmenu.style.justifyContent,
  navmenu2styledisplay: navmenu2.style.display,
  navmenu2styleflexDirection: navmenu2.style.flexDirection,
  navmenu2stylealignItems: navmenu2.style.alignItems,
  navmenustyleflexDirection: navmenu.style.flexDirection,
  navmenustyleheight: navmenu.style.height,
  navmenustylemarginRight: navmenu.style.marginRight,
  navlinkastyletextAlign: navlinka.style.textAlign,
  navlinkbstyletextAlign: navlinkb.style.textAlign,
  navlinkcstyletextAlign: navlinkc.style.textAlign,
  navlinkdstyletextAlign: navlinkd.style.textAlign,
  navlinkestyletextAlign: navlinke.style.textAlign,
  navlinkastylejustifyContent: navlinka.style.justifyContent,
  navlinkbstylejustifyContent: navlinkb.style.justifyContent,
  navlinkcstylejustifyContent: navlinkc.style.justifyContent,
  navlinkdstylejustifyContent: navlinkd.style.justifyContent,
  navlinkestylejustifyContent: navlinke.style.justifyContent,
  navlinkastylealignItems: navlinka.style.alignItems,
  navlinkbstylealignItems: navlinkb.style.alignItems,
  navlinkcstylealignItems: navlinkc.style.alignItems,
  navlinkdstylealignItems: navlinkd.style.alignItems,
  navlinkestylealignItems: navlinke.style.alignItems,

navlinkastylemarginTop: navlinka.style.marginTop,
navmenu2stylepaddingRight: navmenu2.style.paddingRight,
navlinkastylemarginRight: navlinka.style.marginRight,
navlinkbstylemarginRight: navlinkb.style.marginRight,
navlinkcstylemarginRight: navlinkc.style.marginRight,
navlinkdstylemarginRight: navlinkd.style.marginRight,
navlinkestylemarginRight: navlinke.style.marginRight,
navlinkastylepadding: navlinka.style.padding,
navlinkbstylepadding: navlinkb.style.padding,
navlinkcstylepadding: navlinkc.style.padding,
navlinkdstylepadding: navlinkd.style.padding,
navlinkestylepadding: navlinke.style.padding,
navlinkastylefontWeight: navlinka.style.fontWeight,
navlinkbstylefontWeight: navlinkb.style.fontWeight,
navlinkcstylefontWeight: navlinkc.style.fontWeight,
navlinkdstylefontWeight: navlinkd.style.fontWeight,
navlinkestylefontWeight: navlinke.style.fontWeight,
navlinkastyleopacity: navlinka.style.opacity,
navlinkbstyleopacity: navlinkb.style.opacity,
navlinkcstyleopacity: navlinkc.style.opacity,
navlinkdstyleopacity: navlinkd.style.opacity,
 navlinkestyleopacity: navlinke.style.opacity,
navlinkastyleheight: navlinka.style.height,
navlinkbstyleheight: navlinkb.style.height,
navlinkcstyleheight: navlinkc.style.height,
navlinkdstyleheight: navlinkd.style.height,
navlinkestyleheight: navlinke.style.height,

navbarstyleheight:navbar.style.height,

buttonstylewidth: button.style.width,
buttonstylecolor: button.style.color,
buttonstylebackground: button.style.background,
buttonstyleboxShadow: button.style.boxShadow,
buttonstylepadding: button.style.padding,
buttonstylepaddingRight: button.style.paddingRight,
buttonstyleheight: button.style.height,
buttonstylemarginBottom: button.style.marginBottom,
buttonstylefontSize: button.style.fontSize,
buttonstylemarginLeft: button.style.marginLeft,
buttonstyleopacity: button.style.opacity,
buttonstylejustifyContent: button.style.justifyContent,
buttoninnerHTML: button.innerHTML,
buttonstylefontFamily: button.style.fontFamily,
buttonstylepaddingLeft: button.style.paddingLeft,


navlinkastylepaddingRight:navlinka.style.paddingRight,
navlinkbstylepaddingRight:navlinkb.style.paddingRight,
navlinkcstylepaddingRight:navlinkc.style.paddingRight,
navlinkdstylepaddingRight:navlinkd.style.paddingRight,
navlinkestylepaddingRight:navlinke.style.paddingRight,
...
/*
  ...
  navmenu.style.backgroundColor = navmenustylebackgroundColor = navmenu.style.backgroundColor;
  navmenu.style.borderRadius = navmenustyleborderRadius = navmenu.style.borderRadius;
  iconnavmenu.style.backgroundColor = iconnavmenustylebackgroundColor = iconnavmenu.style.backgroundColor;
  navmenubutton.style.backgroundColor = navmenubuttonstylebackgroundColor = navmenubutton.style.backgroundColor;
  navmenubutton.style.marginRight = navmenubuttonstylemarginRight = navmenubutton.style.marginRight;
  container.style.justifyContent = originalStyles.containerstylejustifyContent = container.style.justifyContent;
  brand.style.display = brandstyledisplay = brand.style.display;
  navmenu.style.justifyContent = navmenustylejustifyContent = navmenu.style.justifyContent;
  navmenu2.style.display = navmenu2styledisplay = navmenu2.style.display;
  navmenu2.style.flexDirection = navmenu2styleflexDirection = navmenu2.style.flexDirection;
  navmenu2.style.alignItems = navmenu2stylealignItems = navmenu2.style.alignItems;
  navmenu.style.flexDirection = navmenustyleflexDirection = navmenu.style.flexDirection;
  navmenu.style.height = navmenustyleheight = navmenu.style.height;
  navmenu.style.marginRight = navmenustylemarginRight = navmenu.style.marginRight;
  navlinka.style.textAlign = navlinkastyletextAlign = navlinka.style.textAlign;
  navlinkb.style.textAlign = navlinkbstyletextAlign = navlinkb.style.textAlign;
  navlinkc.style.textAlign = navlinkcstyletextAlign = navlinkc.style.textAlign;
  navlinkd.style.textAlign = navlinkdstyletextAlign = navlinkd.style.textAlign;
  navlinke.style.textAlign = navlinkestyletextAlign = navlinke.style.textAlign;
  navlinka.style.justifyContent = navlinkastylejustifyContent = navlinka.style.justifyContent;
  navlinkb.style.justifyContent = navlinkbstylejustifyContent = navlinkb.style.justifyContent;
  navlinkc.style.justifyContent = navlinkcstylejustifyContent = navlinkc.style.justifyContent;
  navlinkd.style.justifyContent = navlinkdstylejustifyContent = navlinkd.style.justifyContent;
  navlinke.style.justifyContent = navlinkestylejustifyContent = navlinke.style.justifyContent;
  navlinka.style.alignItems = navlinkastylealignItems = navlinka.style.alignItems;
  navlinkb.style.alignItems = navlinkbstylealignItems = navlinkb.style.alignItems;
  navlinkc.style.alignItems = navlinkcstylealignItems = navlinkc.style.alignItems;
  navlinkd.style.alignItems = navlinkdstylealignItems = navlinkd.style.alignItems;
  navlinke.style.alignItems = navlinkestylealignItems = navlinke.style.alignItems;

  navlinka.style.marginTop = navlinkastylemarginTop = navlinka.style.marginTop;
  navmenu2.style.paddingRight = navmenu2stylepaddingRight = navmenu2.style.paddingRight;
  navlinka.style.marginRight = navlinkastylemarginRight = navlinka.style.marginRight;
  navlinkb.style.marginRight = navlinkbstylemarginRight = navlinkb.style.marginRight;
  navlinkc.style.marginRight = navlinkcstylemarginRight = navlinkc.style.marginRight;
  navlinkd.style.marginRight = navlinkdstylemarginRight = navlinkd.style.marginRight;
  navlinke.style.marginRight = navlinkestylemarginRight = navlinke.style.marginRight;
  navlinka.style.padding = navlinkastylepadding = navlinka.style.padding;
  navlinkb.style.padding = navlinkbstylepadding = navlinkb.style.padding;
  navlinkc.style.padding = navlinkcstylepadding = navlinkc.style.padding;
  navlinkd.style.padding =  navlinkdstylepadding = navlinkd.style.padding;
  navlinke.style.padding = navlinkestylepadding = navlinke.style.padding;
  navlinka.style.fontWeight =  navlinkastylefontWeight = navlinka.style.fontWeight;
  navlinkb.style.fontWeight = navlinkbstylefontWeight = navlinkb.style.fontWeight;
  navlinkc.style.fontWeight = navlinkcstylefontWeight = navlinkc.style.fontWeight;
  navlinkd.style.fontWeight = navlinkdstylefontWeight = navlinkd.style.fontWeight;
  navlinke.style.fontWeight = navlinkestylefontWeight = navlinke.style.fontWeight;
  navlinka.style.opacity = navlinkastyleopacity = navlinka.style.opacity;
  navlinkb.style.opacity = navlinkbstyleopacity = navlinkb.style.opacity;
  navlinkc.style.opacity = navlinkcstyleopacity = navlinkc.style.opacity;
  navlinkd.style.opacity = navlinkdstyleopacity = navlinkd.style.opacity;
  navlinke.style.opacity = navlinkestyleopacity = navlinke.style.opacity;
  navlinka.style.height = navlinkastyleheight = navlinka.style.height;
  navlinkb.style.height = navlinkbstyleheight = navlinkb.style.height;
  navlinkc.style.height = navlinkcstyleheight = navlinkc.style.height;
  navlinkd.style.height = navlinkdstyleheight = navlinkd.style.height;
  navlinke.style.height = navlinkestyleheight = navlinke.style.height;





  buttonstylewidth = button.style.width = buttonstylewidth;
  buttonstylecolor = button.style.color = buttonstylecolor;
  buttonstylebackground = button.style.background = buttonstylebackground;
  buttonstyleboxShadow = button.style.boxShadow = buttonstyleboxShadow;
  buttonstylepadding = button.style.padding = buttonstylepadding;
  buttonstylepaddingRight = button.style.paddingRight = buttonstylepaddingRight;
  buttonstyleheight = button.style.height = buttonstyleheight;
  buttonstylemarginBottom = button.style.marginBottom = buttonstylemarginBottom;
  buttonstylefontSize = button.style.fontSize = buttonstylefontSize;
  buttonstylecolor = button.style.color = buttonstylecolor;
  buttonstylemarginLeft = button.style.marginLeft = buttonstylemarginLeft;
  buttonstyleopacity = button.style.opacity = buttonstyleopacity;
  buttonstylejustifyContent = button.style.justifyContent = buttonstylejustifyContent;
  buttoninnerHTML=button.innerHTML = buttoninnerHTML;
  buttonstylefontFamily = button.style.fontFamily = buttonstylefontFamily;
  */
...
function openMenu() {
  ...
  navmenu.style.borderRadius = "25px";
  ...
  container.style.justifyContent=originalStyles.containerstylejustifyContent;
  navmenu.style.justifyContent="right";
  navmenu2.style.display = "flex";
  navmenu2.style.flexDirection = "column";
  navmenu2.style.alignItems="right";
  navmenu.style.flexDirection="row";
  navmenu.style.height = "auto";
  navmenu.style.marginRight = "0px";
  /*navbar.style.background="#fff";*/
navlinka.style.textAlign="right";
  navlinkb.style.textAlign="right";
  navlinkc.style.textAlign="right";
  navlinkd.style.textAlign="right";
  navlinke.style.textAlign="right";

  navlinka.style.justifyContent="right";
  navlinkb.style.justifyContent="right";
  navlinkc.style.justifyContent="right";
  navlinkd.style.justifyContent="right";
  navlinke.style.justifyContent="right";

  navlinka.style.alignItems="center";
  navlinkb.style.alignItems="center";
  navlinkc.style.alignItems="center";
  navlinkd.style.alignItems="center";
  navlinke.style.alignItems="center";

  navlinka.style.marginTop = "20px";
  navmenu2.style.paddingRight = "40px";
  navlinka.style.marginRight = "0px";
  navlinkb.style.marginRight = "0px";
  navlinkc.style.marginRight = "0px";
  navlinkd.style.marginRight = "0px";
  navlinke.style.marginRight = "0px";
  navlinka.style.padding = "0px";
  navlinkb.style.padding = "0px";
  navlinkc.style.padding = "0px";
  navlinkd.style.padding = "0px";
  navlinke.style.padding = "0px";
  navlinka.style.fontWeight = "700";
  navlinkb.style.fontWeight = "700";
  navlinkc.style.fontWeight = "700";
  navlinkd.style.fontWeight = "700";
  navlinke.style.fontWeight = "700";
  navlinka.style.opacity = "1";
  navlinkb.style.opacity = "1";
  navlinkc.style.opacity = "1";
  navlinkd.style.opacity = "1";
  navlinke.style.opacity = "1";
  navlinka.style.height = "40px";
  navlinkb.style.height = "40px";
  navlinkc.style.height = "40px";
  navlinkd.style.height = "40px";
  navlinke.style.height = "40px";
  ...
  button.style.fontFamily="chillax light";
}

// Function to close the menu
function closeMenu() {

  iconnavmenu.style.backgroundColor = originalStyles.iconnavmenustylebackgroundColor;
  navmenubutton.style.backgroundColor = originalStyles.navmenubuttonstylebackgroundColor;
  ...
  setTimeout(() => {
      navmenubutton.style.marginRight = originalStyles.marginRight;
        ...
        container.style.justifyContent = originalStyles.containerstylejustifyContent;
      navmenu.style.height = originalStyles.navmenustyleheight;
      navmenu.classList.remove("open");
      navmenu.style.backgroundColor = originalStyles.navmenustylebackgroundColor;
      navmenu2.style.flexDirection = "row";
      navmenu2.style.paddingRight = "0px";
      navbar.style.background = originalStyles.navbarBackground;
      navbar.style.height = originalStyles.navbarstyleheight;
      navlinka.style.textAlign = originalStyles.navlinkastyletextAlign;
      navlinkb.style.textAlign = originalStyles.navlinkbstyletextAlign;
      navlinkc.style.textAlign = originalStyles.navlinkcstyletextAlign;
      navlinkd.style.textAlign = originalStyles.navlinkdstyletextAlign;
      navlinke.style.textAlign = originalStyles.navlinkestyletextAlign;
      navlinka.style.height = originalStyles.navlinkastyleheight;
      navlinkb.style.height = originalStyles.navlinkbstyleheight;
      navlinkc.style.height = originalStyles.navlinkcstyleheight;
      navlinkd.style.height = originalStyles.navlinkdstyleheight;
      navlinke.style.height = originalStyles.navlinkestyleheight;
      navlinka.style.fontWeight = originalStyles.navlinkastylefontWeight;
      navlinkb.style.fontWeight = originalStyles.navlinkbstylefontWeight;
      navlinkc.style.fontWeight = originalStyles.navlinkcstylefontWeight;
      navlinkd.style.fontWeight = originalStyles.navlinkdstylefontWeight;
      navlinke.style.fontWeight = originalStyles.navlinkestylefontWeight;
      navlinka.style.opacity = originalStyles.navlinkastyleopacity;
      navlinkb.style.opacity = originalStyles.navlinkbstyleopacity;
      navlinkc.style.opacity = originalStyles.navlinkcstyleopacity;
      navlinkd.style.opacity = originalStyles.navlinkdstyleopacity;
      navlinke.style.opacity = originalStyles.navlinkestyleopacity;
      navlinka.style.padding = "20px";
      navlinkb.style.padding = "20px";
      navlinkc.style.padding = "20px";
      navlinkd.style.padding = "20px";
      navlinke.style.padding = "20px";
      navlinka.style.paddingTop = "20px";
      navlinkb.style.paddingTop = "20px";
      navlinkc.style.paddingTop = "20px";
      navlinkd.style.paddingTop = "20px";
      navlinke.style.paddingTop = "20px";
      navlinka.style.marginTop = "0px";
      navlinka.style.marginRight = "0px";
      navlinkb.style.marginRight = "0px";
      navlinkc.style.marginRight = "0px";
      navlinkd.style.marginRight = "0px";
      navlinke.style.marginRight= "0px";
      button.style.color=originalStyles.buttonstylecolor;
  }, 200); // Adjust the duration to match the CSS transition time

  setTimeout(() => { 
    button.style.width=originalStyles.buttonstylewidth;
    button.style.background=originalStyles.buttonstylebackground;
    button.style.padding=originalStyles.buttonstylepadding;
    button.style.paddingRight=originalStyles.buttonstylepaddingRight;
    button.style.paddingLeft=originalStyles.buttonstylepaddingLeft;
    button.style.height=originalStyles.buttonstyleheight;
    button.style.maxWidth=originalStyles.maxWidth;
    button.style.fontSize=originalStyles.buttonstylefontSize;
    button.innerHTML="LOGIN";
    button.style.fontFamily=originalStyles.buttonstylefontFamily;
    button.style.opacity = originalStyles.buttonstyleopacity;
