...
document.addEventListener('DOMContentLoaded', () => {
    ...
    observer.observe(document.querySelector('.div-block-2'));
  });
...
function openMenu() {
    ...
    iconnavmenu.style.backgroundColor = "#1e1e1e";
    navmenubutton.style.backgroundColor = "#1e1e1e";
    ...
    navlink.style.fontFamily="Lemonmilk, sans-serif";
    navlink2.style.fontFamily="Lemonmilk, sans-serif";
    navlink3.style.fontFamily="Lemonmilk, sans-serif";
    navlink4.style.fontFamily="Lemonmilk, sans-serif";
    navlink5.style.fontFamily="Lemonmilk, sans-serif";
}
...
function closeMenu() {
    ...
    setTimeout(() => {
        ...
        navlink.style.fontFamily = "Gambetta, sans-serif";
        navlink2.style.fontFamily = "Gambetta, sans-serif";
        navlink3.style.fontFamily = "Gambetta, sans-serif";
        navlink4.style.fontFamily = "Gambetta, sans-serif";
        navlink5.style.fontFamily = "Gambetta, sans-serif";
        button.style.width = "90px";
        button.style.backgroundColor = "#1e1e1e";
        button.style.backgroundImage = "linear-gradient(0deg, #1e1e1e, #383838)";
        button.style.boxShadow = "8px 2px 12px rgba(0, 0, 0, .2)";
        button.style.padding = originalStyles.padding;
        button.style.paddingRight = originalStyles.padding;
